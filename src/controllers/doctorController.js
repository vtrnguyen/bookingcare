...
let getListBookedPatient = async (req, res) => {
    try {
        let data = await doctorService.getListBookedPatient(req.query.doctorId, req.query.date);
        return res.status(200).json(data);
    } catch(e) {
        console.log(e);
        return res.status(200).json({
...
let postSendingRemedy = async (req, res) => {
    try {
        let data = await doctorService.postSendingRemedy(req.body);
        return res.status(200).json(data);
    } catch(e) {
        console.log(e);
        return res.status(200).json({
